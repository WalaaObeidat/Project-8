...
function AddBook() {
  ...
  return (
      <>
        ...
        <img id='imgNav' src={require('../images/logoo.png')} alt="" />
        <Container>
        ...
        <div id="landing">
            ...
            <div id="diver"><h1 className="text-center font-bold text-2xl" id="head">Add New Books</h1></div>

            <div id= "formm">
                <section className="section_form">
                    <form id="consultation-form" className="feed-form" onSubmit={handleSubmit}>
                        <input  name="title" placeholder="Book Title" type="text" id="text" value={title} onChange={(e) => setTitle(e.target.value)} /><br /><br />
                        <input  name="title" placeholder="Book Auther" type="text" id="text" value={auther} onChange={(e) => setAuther(e.target.value)} /><br /><br />
                        <input name="description" style={{height: '6vw'}}  placeholder="Book Description"  type="text" id="text" value={description} onChange={(e) => setDescription(e.target.value)} /><br /><br />
                        <input type="file"  name="img" id="file" accept="image/*"  onChange={(e) =>setFile(e.target.files[0])} hidden/>
                        <label className="label" htmlFor="file">
                            <img id="imgAdd" src={require('../images/add.png')} alt="" />
                            <p id="imgLabel">Add Image To Your Novel</p>
                        </label>
                        <br/>
                        <button id="addNovelDB" type="submit"><img src={require('../images/addbook.png')} alt="" /></button>
                    </form>
                </section>
            </div>
        </div>
